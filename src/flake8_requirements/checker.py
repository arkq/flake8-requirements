...
class Flake8Checker(object):
    ...
    def parse_options(cls, options):
        ...
        cls.setup = cls.get_setup()
        cls.mods_1st_party = cls.get_mods_1st_party()
        cls.mods_3rd_party = cls.get_mods_3rd_party()
    ...
    def get_mods_1st_party(cls):
        ...
        modules = [project2module(cls.setup.keywords.get('name', ""))]
    ...
    def get_mods_3rd_party(cls):
        ...
        if cls.setup.redirected:
            # Use requirements from setup if available.
            requirements = cls.setup.get_requirements(
    ...
    def run(self):
        """Run checker."""
        mods_1st_party = self.mods_1st_party
        mods_3rd_party = self.mods_3rd_party
